...
@section('content')
    ...
    <div class="card mb-5 mb-xl-8">
        ...
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bold fs-3 mb-1">الادارات التعليمية </span>
            ...
            <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover"
                ...
                <a href="#" data-bs-toggle="modal" data-bs-target="#kt_modal_new_address" class="btn btn-sm btn-light btn-active-primary">
                    ...
                    <!--end::Svg Icon-->اضافه ادارة تعليمية</a>
            </div>
        </div>
        <!--end::Header-->
        <!--begin::Body-->
            ...
            <div class="table-responsive">
                ...
                <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                    ...
                    <tr class="fw-bold text-muted">
                        ...
                        <th class="min-w-200px">اسم الادارة </th>
                        <th class="min-w-200px">المديرية </th>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex justify-content-end flex-shrink-0">
                                    ...
                                    <a href="{{url('Delete-EducationalAdministration/'.$Stu->id)}}"
    ...
    <div class="modal fade" id="kt_modal_new_address" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                <!--begin::Form-->
                <form class="form" method="post" action="{{url('Save-EducationalAdministration')}}" id="kt_modal_new_address_form">
                    <!--begin::Modal header-->
                    <div class="modal-header" id="kt_modal_new_address_header">
                        <!--begin::Modal title-->
                        <h2>اضافة ادارة تعليمية</h2>
                        <!--end::Modal title-->
                        <!--begin::Close-->
                    ...
                    <div class="modal-body py-10 px-lg-17">
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-md-6 fv-row">
                                <!--end::Label-->
                                <label class="required fs-5 fw-semibold mb-2">اسم الادارة التعليمية </label>
                                <!--end::Label-->
                                <!--end::Input-->

                                <input type="text" class="form-control form-control-solid"  name="Name" placeholder="اسم الادارة التعليمية" value="{{old('Name')}}" />
                                <!--end::Input-->
                                @error('Name')
                            ...
                            <div class="col-md-6 fv-row">
                                ...
                                <select class="form-control form-control-solid"  name="GovernmentId" placeholder="اسم الادارة التعليمية" value="{{old('GovernmentId')}}" >
    ...
    <div class="modal fade" id="kt_modal_new_address2" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                <!--begin::Form-->
                <form class="form" method="post" action="{{url('Update-EducationalAdministration')}}" id="kt_modal_new_address_form">
                    <!--begin::Modal header-->
                    <div class="modal-header" id="kt_modal_new_address_header">
                        <!--begin::Modal title-->
                        <h2>تعديل مديرية</h2>
                    ...
                    <div class="modal-body py-10 px-lg-17">
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-md-6 fv-row">
                                ...
                                <input type="text" class="form-control form-control-solid"  name="Name" placeholder="اسم الادارة التعليمية" id="EditName" />
                            ...
                            <div class="col-md-6 fv-row">
                                ...
                                <select class="form-control form-control-solid" id="GovernmentId"  name="GovernmentId" placeholder="اسم الادارة التعليمية" value="{{old('GovernmentId')}}" >
                                    @foreach($Governs as $gov)
                                        <option value="{{$gov->id}}">{{$gov->Name }}</option>
                                    @endforeach
                                </select>
...
<script>
    function call(id){
        $.ajax({
            type: "GET",
            url: "Edit-EducationalAdministration/"+id,
