        ...
        <div class="card mb-5 mb-xl-8">
            ...
            <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bold fs-3 mb-1">الوجبات </span>

                </h3>
                <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover" title="Click to add a user">


                    <a href="{{url('Add-Meal')}}" class="btn btn-sm btn-light btn-active-primary" >
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                        ...
                        <tr class="fw-bold text-muted">
                            ...
                            <th class="min-w-200px">اسم الوجبة</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-end flex-shrink-0">
                                        ...
                                        <a href="{{url('Edit-Meal/'.$Stu->id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                        ...
                                        <a href="{{url('Delete-Meal/'.$Stu->id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
