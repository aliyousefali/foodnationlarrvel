...
@section('content')
    ...
    <div class="card mb-5 mb-xl-8">
        ...
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bold fs-3 mb-1">المدريات </span>
            ...
            <div class="table-responsive">
                ...
                <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                    ...
                    <tr class="fw-bold text-muted">
                        ...
                        <th class="min-w-200px">اسم المديرية</th>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex justify-content-end flex-shrink-0">
                                    ...
                                    <a href="{{url('Delete-Government/'.$Stu->id)}}"
    ...
    <div class="modal fade" id="kt_modal_new_address" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                <!--begin::Form-->
                <form class="form" method="post" action="{{url('Save-Government')}}" id="kt_modal_new_address_form">
                    <!--begin::Modal header-->
                    ...
                    <div class="modal-body py-10 px-lg-17">
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-md-12 fv-row">
                                <!--end::Label-->
                                <label class="required fs-5 fw-semibold mb-2">اسم المديرية </label>
                                <!--end::Label-->
                                <!--end::Input-->

                                <input type="text" class="form-control form-control-solid"  name="Name" placeholder="اسم المديرية" value="{{old('Name')}}" />
                                <!--end::Input-->
                                @error('Name')
    ...
    <div class="modal fade" id="kt_modal_new_address2" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                <!--begin::Form-->
                <form class="form" method="post" action="{{url('Update-Government')}}" id="kt_modal_new_address_form">
                    <!--begin::Modal header-->
                    <div class="modal-header" id="kt_modal_new_address_header">
                        <!--begin::Modal title-->
                        <h2>تعديل مديرية</h2>
                    ...
                    <div class="modal-body py-10 px-lg-17">
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-md-12 fv-row">
                                ...
                                <input type="text" class="form-control form-control-solid"  name="Name" placeholder="اسم المديرية" id="EditName" />
