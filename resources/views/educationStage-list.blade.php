...
@section('content')
    ...
    <div class="card mb-5 mb-xl-8">
        ...
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bold fs-3 mb-1">المراحل التعليمية </span>
            ...
            <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover"
                ...
                <a href="#" data-bs-toggle="modal" data-bs-target="#kt_modal_new_address" class="btn btn-sm btn-light btn-active-primary">
                    ...
                    <!--end::Svg Icon-->اضافه مراحلة تعليمية</a>
            </div>
        </div>
        <!--end::Header-->
        <!--begin::Body-->
            ...
            <div class="table-responsive">
                ...
                <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                    ...
                    <tr class="fw-bold text-muted">
                        ...
                        <th class="min-w-200px">اسم المراحلة تعليمية</th>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex justify-content-end flex-shrink-0">
                                    ...
                                    <a href="{{url('Delete-EducationStage/'.$Stu->id)}}"
    ...
    <div class="modal fade" id="kt_modal_new_address" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                <!--begin::Form-->
                <form class="form" method="post" action="{{url('Save-EducationStage')}}" id="kt_modal_new_address_form">
                    <!--begin::Modal header-->
                    <div class="modal-header" id="kt_modal_new_address_header">
                        <!--begin::Modal title-->
                        <h2>اضافة مراحلة تعليمية</h2>
                        <!--end::Modal title-->
                        <!--begin::Close-->
                    ...
                    <div class="modal-body py-10 px-lg-17">
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-md-12 fv-row">
                                <!--end::Label-->
                                <label class="required fs-5 fw-semibold mb-2">اسم المراحلة تعليمية </label>
                                <!--end::Label-->
                                <!--end::Input-->

                                <input type="text" class="form-control form-control-solid"  name="Name" placeholder="اسم المراحلة تعليمية" value="{{old('Name')}}" />
                                <!--end::Input-->
                                @error('Name')
    ...
    <div class="modal fade" id="kt_modal_new_address2" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                <!--begin::Form-->
                <form class="form" method="post" action="{{url('Update-EducationStage')}}" id="kt_modal_new_address_form">
                    <!--begin::Modal header-->
                    <div class="modal-header" id="kt_modal_new_address_header">
                        <!--begin::Modal title-->
                        <h2>تعديل مراحلة تعليمية</h2>
                        <!--end::Modal title-->
                        <!--begin::Close-->
                        <div class="btn btn-sm btn-icon btn-active-color-primary" data-bs-dismiss="modal">
                            <!--begin::Svg Icon | path: icons/duotune/arrows/arr061.svg-->
                    ...
                    <div class="modal-body py-10 px-lg-17">
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-md-12 fv-row">
                                ...
                                <input type="text" class="form-control form-control-solid"  name="Name" placeholder="اسم المراحلة تعليمية" id="EditName" />
                        ...
                        <div class="fv-row mb-5">
                            ...
                            <div class="d-flex flex-stack">
                                ...
                                <label class="form-check form-switch form-check-custom form-check-solid">
                                    ...
                                    <input class="form-check-input Status" name="Status" type="checkbox" value="1" id="Status"  />
                                        <!--end::Input-->
                                    <!--begin::Label-->
                                    <span class="form-check-label fw-semibold text-muted">مفعل</span>
                                    <!--end::Label-->
